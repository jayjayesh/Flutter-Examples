...
class Constants {
  static double heightBetweenWidgets = 12;

//==========TextStyle================
  static const TextStyle textStyleLoginButton =
      TextStyle(color: Colors.white, fontWeight: FontWeight.bold);

  static const TextStyle textStyleLoggedInSuccessfully =
      TextStyle(color: Colors.blue, fontWeight: FontWeight.bold, fontSize: 40);

//==========InputDecoration================

  static const InputDecoration inputDecorationUserName = InputDecoration(
      labelText: "User Name",
      //hintText: " ",
